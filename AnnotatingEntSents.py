...
ARCHITECTURE_TYPE = ['perceptron', 'feed forward', 'radial basis network', 'recurrent neural network',
                     ...
                     'support vector machine', 'neural turing machine', 'rnn', 'lstm', 'gru', 'rbm', 'gan', 'lsm',
                     'elm', 'esn', 'drn', 'svm', 'ntm']
...
BUILDING_BLOCKS = ['fully connected layer', 'fully-connected layer', 'recurrent layer', 'pooling layer',
                   'convolutional layer', 'convolution layer', 'deconvolutional layer', 'deconvolution layer',
        ...
        for category in CATEGORIES.keys():
            ...
            for line in allLines:
                ...
                for entity in CATEGORIES[category]:
                    regex = r'(?<=\()' + entity + r's?(?=\))|\b' + entity + r's?\b'
